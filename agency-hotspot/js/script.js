    ...
    if($(window).width() < 1280) {
        ...
        $('#pagepiling').pagepiling({
            ...
            navigation: {
                'bulletsColor': '#535353',
                'position': 'left',
                'tooltips': ['Cambio Climático en Uruguay', 'Vientos y mareas', 'Gases de efecto invernadero', 'Uruguay vulnerable', 'Escenarios predictivos', '¿Cómo nos adaptamos?','Vos y tu comunidad','Contacto'],
            },
